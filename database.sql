...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 12, 2023 lúc 02:00 PM
...
CREATE TABLE `chitietsanpham` (
  ...
  `MASP` int(11) NOT NULL,
  `TENCHITIET` text CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `GIATRI` text CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
('864895024878082', 14, 'HTC S720t', 'qqqq', 'eeeee', 4, '14/11/2019'),
('864895024878082', 87, 'HTC S720t', 'were', 'wefwefwef', 0, '14/11/2019');
...
CREATE TABLE `hoadon` (
  `MAHD` int(11) NOT NULL,
  `NGAYMUA` text CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `NGAYGIAO` text CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `TRANGTHAI` text CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `TENNGUOINHAN` text CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `SODT` text CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `DIACHI` text CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CHUYENKHOAN` tinyint(1) DEFAULT NULL,
  `MACHUYENKHOAN` text CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
...
(7, '05/09/2019', '12/05/2019', 'chờ kiểm duyệt', 'Che Cong Binh', '09048349834', '54 Tran Hung Dao Phuong Cau Kho Quan 1', NULL, NULL),
(8, '07/09/2019', '12/07/2019', 'chờ kiểm duyệt', 'Che Cong Binh', '0907488433', '56 Tran Hung Dao Quan 1', 0, 'không có'),
(9, '07/09/2019', '12/07/2019', 'chờ kiểm duyệt', 'Che Cong Binh', '0903838938', '32 Tran Hung dao', 0, NULL);
...
(1, 2, 'Xã hàng hot đến 49%', '2016/9/12', '2019/10/12', '/hinhkhuyenmai/con loc giam gia mua he.png'),
(2, 2, 'Giải nhiệt mùa hè giảm ngay 50%', '2016/9/12', '2019/10/12', '/hinhkhuyenmai/khuyen mai ta quan ta dan.jpg'),
(3, 2, 'Hè này mua gì ?', '2016/9/12', '2019/10/12', '/hinhkhuyenmai/du lich.jpg'),
(4, 3, 'Festival salve !', '2016/9/12', '2019/9/12', '/hinhkhuyenmai/festival sale 90.jpg');
...
(1, 'tam', 'binh@gmail.com', 'Binh123', NULL, NULL, NULL, NULL, 2, ''),
(2, 'class', 'mys@email.com', 'Binh123', NULL, NULL, NULL, NULL, 2, ''),
(3, 'trong', 'as@gmail.com', 'Binh123', NULL, NULL, NULL, NULL, 2, ''),
...
CREATE TABLE `thuonghieu` (
  ...
  `HINHTHUONGHIEU` text DEFAULT NULL,
  `LUOTMUA` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
